...
<body>
    ...
    <main role="main" class="container">
        ...
        <div class="VSC-video-container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="VSC-video-container-embed-responsive VSC-video-container-embed-responsive-16by9">
                        <iframe class="VSC-video-container-embed-responsive-item" src="./videoWidget.php?id=Bergenstal&lang=all" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
